                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="col-lg-4">
                              <div class="form-group">
                                   ...
                                   <input pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==15) return false;" type="number" name="phonenumber" class="form-control" value="<?php echo $_SESSION['loggedUser']->getPhoneNumber() ?>" placeholder="<?php echo $_SESSION['loggedUser']->getPhoneNumber() ?>" required>
                              </div>
                        </div>
